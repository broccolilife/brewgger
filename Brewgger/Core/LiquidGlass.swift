...
// From Pixel knowledge (2026-02-25): Tab bars get automatic Liquid Glass treatment
// Brewgger: toolbar + tab bar will auto-adopt; verify content isn't obscured
...
extension View {
    /// Glass material card — use for toolbars, recipe cards, NOT list rows
...
extension View {
    /// Pulsing attention effect for brew timers, notifications
    ...
    /// Bounce-in entrance for recipe cards
